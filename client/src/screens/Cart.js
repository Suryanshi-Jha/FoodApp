...
export default function Cart() {
  ...
  if (data.length === 0) {
    return (
      <div>
        <div className='m-5 w-100 text-center' style={{color:'white'}}>The Cart is Empty!</div>
      </div>
    )
  }
      ...
      <div className='container m-auto mt-5 table-responsive  table-responsive-sm table-responsive-md' style={{color:'white'}}>
        <table className='table table-hover ' style={{color:'white'}}>
          <thead className=' text-success fs-4'>
            <tr>
              <th scope='col' style={{color:'#2E8B57'}}>#</th>
              <th scope='col' style={{color:'#2E8B57'}}>Name</th>
              <th scope='col' style={{color:'#2E8B57'}}>Quantity</th>
              <th scope='col' style={{color:'#2E8B57'}}>Option</th>
              <th scope='col' style={{color:'#2E8B57'}}>Amount</th>
              <th scope='col' style={{color:'#2E8B57'}}></th>
            </tr>
          </thead>
          <tbody>
